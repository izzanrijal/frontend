...
const register = async () => {
  try {
    ...
    const response = await axios.post('https://gateway.berkompeten.comapi/student/register', {
      email: form.email,
...
const fetchExamDateOptions = async () => {
  try {
    const response = await axios.get('https://gateway.berkompeten.comapi/student/exam-date')
...
const fetchUniversityOptions = async () => {
  try {
    const response = await axios.get('https://gateway.berkompeten.comapi/student/university')
    // Assuming the API response has an array of educational statuses
...
const fetchEducationalStatusOptions = async () => {
  try {
    const response = await axios.get('https://gateway.berkompeten.comapi/student/educational-status')
    // Assuming the API response has an array of educational statuses
